...
const robotrouter = express_1.default.Router();
robotrouter.get("/test1", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.send("test1");
}));
robotrouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// 로봇 이름, 번호, IP 저장
robotrouter.post("/api/createrobotlist", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// 로봇 정보 수정
robotrouter.post("/api/updaterobot", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!fs_1.default.existsSync('RobotSettings.json')) {
...
// 로봇 정보 삭제
robotrouter.post("/api/deleterobotlist", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!fs_1.default.existsSync('RobotSettings.json')) {
            return res.status(404).send("File not found");
        }
...
// 로봇 리스트 받아서 브라우저에 출력
robotrouter.get("/api/getrobotlist", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    fs_1.default.readFile('RobotSettings.json', 'utf8', (err, fileData) => {
        if (err)
            throw err;
        let data = fileData ? JSON.parse(fileData) : [];
